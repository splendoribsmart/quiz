...
from .views import (
    ...
    leaderboard_view, leaderboard_desktop_view, leaderboard_phone_view,
...
urlpatterns = [
    ...
    path('leaderboard-desktop/', leaderboard_desktop_view, name='leaderboarddesktop'),
    path('leaderboard-phone/', leaderboard_phone_view, name='leaderboardphone'),
